...
public class GolGolGolWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(GolGolGolWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/GolGolGolWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/GolGolGolWLAIW/InitOutcome.xml").getDocumentElement();
